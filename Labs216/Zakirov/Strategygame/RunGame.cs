...
using Labs216.Zakirov.Strategygame.Army;
using Labs216.Zakirov.Strategygame.Buildings;
using Labs216.Zakirov.Strategygame.Workers;
using System;
...
namespace Labs216.Zakirov.Strategygame
{
    class RunGame
    {
        public static void Run()
        {
            ...
            var catapult = new Catapulta(2, 2, 2);
            ...
            var cavalry = new Cavalery(3, 3, 3);
            ...
            var swordsMan = new Spearman(5, 5, 5);
