...
namespace Labs216.Anisimov
{
    class Calculates
    {
        ...
        public static void PythagoreanTheorem()
        {
            ...
            Console.Write("c:");
            double c = double.Parse(Console.ReadLine());
            if (a == -1) //Пользователь может выберать что ему надо, в зависимости от того какие данные у него есть
            {
                a = c * c - b * b;
        ...
        public static void AmperResVolt()
        {
            ...
            if (I == -1) //Пользователь может выберать что ему надо, в зависимости от того какие данные у него есть
            {
                I = U/R;
